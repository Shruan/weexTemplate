...
__vue_options__.__file = "/Users/qiushiyuan/office/GitHub/weexTemplate/src/App.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ccf4bb7c"
...
var _vuexRouterSync = __webpack_require__(13);
...
__vue_options__.__file = "/Users/qiushiyuan/office/GitHub/weexTemplate/src/views/login/login.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-43a6c1ba"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    login: function login() {
      ...
      this.$http.post(url, data, { headers: header }).then(function (res) {
        res = res.data;
        if (res) {
          if (res.code == 0) {
            var user = {
          ...
          _this.$router.push({ path: '/mine/mine' });
        }
      }).catch(function () {
